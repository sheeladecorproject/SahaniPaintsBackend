...
import { ProjectAreaColorsRepository } from "../repository/projectAreaColors.repository.js";
import { ProjectAreaColorsService } from "../service/projectAreaColors.service.js";
import { ProjectAreaColorsController } from "../controller/projectAreaColors.controller.js";
import { errorHandler } from "../factory/error.factory.js";

const router = express.Router();
const controller = GeneralFactory.create(
    ProjectAreaColorsRepository,
    ProjectAreaColorsService,
    ProjectAreaColorsController
);
...
export { router as ProjectAreaColorsRouter };
