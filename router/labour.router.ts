...
import { LaboursRepository } from "../repository/labours.repository.js";
import { LabourService } from "../service/labour.service.js";
import { LabourController } from "../controller/labour.controller.js";
import { errorHandler } from "../factory/error.factory.js";

const router = express.Router();
const controller = GeneralFactory.create(LaboursRepository, LabourService, LabourController);
