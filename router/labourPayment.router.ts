...
import { LabourPaymentsRepository } from "../repository/labourPayments.repository.js";
import { LabourPaymentsService } from "../service/labourPayments.service.js";
import { LabourPaymentController } from "../controller/labourPayment.controller.js";
import { errorHandler } from "../factory/error.factory.js";

const router = express.Router();
const controller = GeneralFactory.create(LabourPaymentsRepository, LabourPaymentsService, LabourPaymentController);
...
export { router as LabourPaymentRouter };
