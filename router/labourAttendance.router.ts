...
import { LabourAttendanceRepository } from "../repository/labourAttendance.repository.js";
import { LabourAttendanceService } from "../service/labourAttendance.service.js";
import { LabourAttendanceController } from "../controller/labourAttendance.controller.js";
import { errorHandler } from "../factory/error.factory.js";

const router = express.Router();
const controller = GeneralFactory.create(LabourAttendanceRepository, LabourAttendanceService, LabourAttendanceController);
...
export { router as LabourAttendanceRouter };
